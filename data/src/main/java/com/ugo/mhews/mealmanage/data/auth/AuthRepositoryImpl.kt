...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun signIn(email: String, password: String): Result<UserId> = withContext(dispatchers.io) {
        try {
    ...
    override suspend fun signUp(email: String, password: String): Result<UserId> = withContext(dispatchers.io) {
        try {
