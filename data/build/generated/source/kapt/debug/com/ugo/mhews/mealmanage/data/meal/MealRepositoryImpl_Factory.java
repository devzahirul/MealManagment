...
public final class MealRepositoryImpl_Factory implements Factory<MealRepositoryImpl> {
  ...
  public MealRepositoryImpl_Factory(Provider<FirebaseFirestore> dbProvider,
  ...
  public static MealRepositoryImpl_Factory create(Provider<FirebaseFirestore> dbProvider,
      Provider<FirebaseAuth> authProvider, Provider<CoroutineDispatcher> ioDispatcherProvider) {
    return new MealRepositoryImpl_Factory(dbProvider, authProvider, ioDispatcherProvider);
  }

  public static MealRepositoryImpl newInstance(FirebaseFirestore db, FirebaseAuth auth,
      CoroutineDispatcher ioDispatcher) {
    return new MealRepositoryImpl(db, auth, ioDispatcher);
  }
}
