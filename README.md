...
[![CI](https://github.com/devzahirul/MealManagment/actions/workflows/ci.yml/badge.svg)](https://github.com/devzahirul/MealManagment/actions/workflows/ci.yml)
<!-- The tests badge is generated by CI on the main branch. 
     It will appear after the first successful run on main. -->
![Tests](badges/tests.svg)
![Coverage](badges/coverage.svg)

Module coverage:

![Domain](badges/coverage-domain.svg)
![Core](badges/coverage-core.svg)
![Data](badges/coverage-data.svg)
![App](badges/coverage-app.svg)
...
- Root XML: `build/reports/kover/xml/report.xml`
